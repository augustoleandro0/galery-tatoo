    ...
    return (
        <main className={`md:ml-52 sm:m-0 h-full text-center md:relative `}>
            <div className={grid.template}>
                ...
                <div  className={`${grid.item3} w-70 col-span-1 -mt-12`}>
                ...
                <div className={`${grid.item4} w-50 col-span-1 -mt-12 `}>
                ...
                <div className={`${grid.item6} w-50 col-span-1 -mt-12 `}>
                ...
                <div className={`${grid.item7} w-50 col-span-1 -mt-12`}>
                ...
                <div className={`${grid.item9} w-50 col-span-1 -mt-12 `}>
                ...
                <div className={`${grid.item10} w-50 col-span-1 -mt-12 `}>
